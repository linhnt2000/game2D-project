...
namespace Com.LuisPedroFonseca.ProCamera2D {
    ...
    public class ProCamera2DNumericBoundaries : BasePC2D, IPositionDeltaChanger, ISizeOverrider {
        ...
        //private float maxY;
        void SetBorder() {
            UseTopBoundary = LevelController.instance.useTop;
            if (UseTopBoundary) {
                ...
                BottomBoundary = LevelController.instance.posMinY.position.y;
                TopBoundary = LevelController.instance.posMaxY.position.y;
            }
            LeftBoundary = LevelController.instance.posMinX.position.x;
            RightBoundary = LevelController.instance.posMaxX.position.x;
        }
